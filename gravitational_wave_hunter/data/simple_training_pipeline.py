...
class SimpleTrainingPipeline:
    ...
    def download_training_data(self, num_samples=100):
        ...
        # Use clean periods from O2 run
        clean_periods = [
            1167210000, 1167220000, 1167230000, 1167240000, 1167250000,
            1167260000, 1167270000, 1167280000, 1167290000, 1167300000,
            1167310000, 1167320000, 1167330000, 1167340000, 1167350000,
            1167360000, 1167370000, 1167380000, 1167390000, 1167400000,
            1167410000, 1167420000, 1167430000, 1167440000, 1167450000,
            1167460000, 1167470000, 1167480000, 1167490000, 1167500000
        ]
