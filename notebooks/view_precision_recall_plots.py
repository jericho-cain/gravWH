#!/usr/bin/env python3
"""
View Precision-Recall Plots - Fixed version that keeps plots open
"""
...
def create_precision_recall_plots(y_true, scores, snr_values=None):
    ...
    print("📁 Main plot saved as 'precision_recall_main.png'")
    ...
    print("📁 Analysis plot saved as 'precision_recall_analysis.png'")
...
def main():
    print("📊 Creating Precision-Recall Plots (Fixed Version)")
    print("=" * 55)
    ...
    print(f"🌊 Computing CWT representations...")
    ...
    # Create plots
    print(f"📊 Creating precision-recall plots...")
    ...
    print(f"  • Precision: {results['optimal_precision']:.1%}")
    print(f"  • Recall: {results['optimal_recall']:.1%}")
    print(f"  • F1-Score: {results['optimal_f1']:.1%}")
    
    print(f"\n🖼️ PLOTS CREATED:")
    print(f"📁 'precision_recall_main.png' - Main precision-recall curves")
    print(f"📁 'precision_recall_analysis.png' - Detailed analysis")
    
    # Keep plots open
    print(f"\n⏸️  Plots are now open and saved as files.")
    print(f"🖼️  You can view the saved PNG files if the plots close.")
