...
The CWT-LSTM autoencoder demonstrates significant practical advantages over template-based approaches. Unlike matched filtering, which requires extensive template banks covering multidimensional parameter spaces, the CWT-LSTM approach learns signal characteristics directly from data, offering computational advantages and enhanced adaptability to unexpected signal types. In gravitational wave astronomy, false alarms impose considerable costs through wasted follow-up observations, computational resources, and scientific credibility. The achieved precision of 90.6\% could meaningfully reduce false alarm rates for operational systems.
