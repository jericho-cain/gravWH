...
Training samples & 80,000 (40,000 noise + 40,000 signal+noise) \\
Validation samples & 10,000 (5,000 noise + 5,000 signal+noise) \\
Test samples & 10,000 (5,000 noise + 5,000 signal+noise) \\
Time series length & 4 seconds (2048 samples at 512 Hz) \\
SNR range & 8--25 (optimal SNR) \\
\hline
\multicolumn{2}{l}{\textbf{Training Configuration}} \\
Batch size & 64 samples \\
Learning rate & $10^{-3}$ (exponential decay 0.95/10 epochs) \\
Dropout rate & 0.2 (LSTM layers) \\
Weight decay & $10^{-5}$ (L2 regularization) \\
Gradient clipping & Maximum norm 1.0 \\
Early stopping & 15 epoch patience (validation loss) \\
...
Model evaluation employs 5-fold stratified cross-validation to ensure robust performance estimates, with each fold maintaining the original class distribution. Final performance metrics represent the mean and standard deviation across all cross-validation folds.
